...
<body>
			...
			<table class="table table-striped table-bordered">
				...
				<tbody id="results">
					<c:forEach items="${listComputer}" var="computer">
						<tr>
							<td><a href="editComputer?computerid=${computer.id}" onclick="">${computer.computerName}</a></td>
							<!-- Variable declarations for passing labels as parameters -->
							<!-- Table header for Computer Name -->
	...
	<footer class="navbar-fixed-bottom">
		<div class="container text-center">
			...
			<!-- 				<a type="button" href="?numberdisplay=50"name="button" value="50" -->
			<!-- 					class="btn btn-default">50</a> -->
			<!-- 				<a type="button" href="?numberdisplay=100" name="button" value="100" -->
